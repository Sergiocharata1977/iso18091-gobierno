...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-border/80 transition-colors hover:bg-muted/40 data-[state=selected]:bg-accent/65',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'px-4 py-3 align-middle leading-6 [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn('mt-4 text-xs leading-5 text-muted-foreground', className)}
    {...props}
  />
));
